...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Upload Successful! All files are intact and verified.').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError('Test case failed: File upload, storage, download, and deletion validations did not pass as per the test plan.')
