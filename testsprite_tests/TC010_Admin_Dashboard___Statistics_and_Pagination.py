...
async def run_test():
    ...
    try:
        ...
        # -> Input admin email and click 'Continuar com Email' to log in as system administrator
        ...
        frame = context.pages[-1]
        # Input 6-digit verification code for login
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Admin Dashboard Statistics Verified Successfully')).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The admin dashboard did not display the expected statistics, pagination controls, or performance optimizations as required by the test plan.")
