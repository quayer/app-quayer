...
async def run_test():
    ...
    try:
        ...
        # -> Input email in Google sign-in form and proceed
        frame = context.pages[-1]
        # Input email in Google sign-in form
        ...
        try:
            ...
            raise AssertionError('Test case failed: User authentication using Google OAuth and token storage verification did not succeed as expected.')
