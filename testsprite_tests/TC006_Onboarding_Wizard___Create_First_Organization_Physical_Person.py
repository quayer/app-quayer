...
async def run_test():
    ...
    try:
        ...
        # -> Input email for new user and click 'Continuar com Email' to log in.
        ...
        # -> Try clicking the input field at index 2 to focus and then send keys for the verification code.
        frame = context.pages[-1]
        # Click the verification code input field to focus
        elem = frame.locator('xpath=html/body/div[2]/div/div/div/div/div[2]/form/div/div/div/div/div[2]/input').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click 'Fazer Login' button to complete login and proceed to onboarding wizard.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test failed: Onboarding wizard did not create a physical person type organization with all required attributes and assign the user role as expected.")
