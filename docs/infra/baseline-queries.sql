-- docs/infra/baseline-queries.sql
-- Queries de baseline para metricas de conversao e saude do fluxo de auth.
-- Movido de docs/auth/baseline-queries.sql em 10/Mai/2026 (consolidacao).
-- Referenciado por docs/infra/BASELINES.md secao 8.5.
...
--
-- Como usar:
--   psql $DATABASE_URL -f docs/infra/baseline-queries.sql
