...
ARG SENTRY_RELEASE=
# NEXT_PUBLIC_SENTRY_DSN é o DSN do projeto frontend (quayer-frontend).
# Vai embarcar no bundle JS do client (NEXT_PUBLIC_* é baked em build-time).
# DSNs do Sentry são públicos por design — não é segredo.
# NEXT_PUBLIC_SENTRY_RELEASE espelha SENTRY_RELEASE pro client SDK.
