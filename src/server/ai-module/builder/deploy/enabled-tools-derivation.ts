 ...
 *
 * Estrutura: helpers PUROS (`derive*ToolChanges` + `reconcileEnabledTools`,
 * zero IO, zero `any`) + UM probe de IO (`hasActiveCalendarConnection`) que
 * espelha o escopo de `resolveCalendarAccess` (src/lib/calendar) — a MESMA
 * fonte que o runtime usa para decidir se a agenda funciona.
 *
