 ...
 *  - Fase Conhecer (objetivo/identidade, texto-livre): chame a tool
 *    `quick_reply_chips` com opções comuns para o usuário tocar em vez de
 *    digitar — o chip vira um turno normal; nunca trave a resposta livre.
 */
