...
// Import directly: import { chatwootSyncService } from '@/server/integration/chatwoot/services/chatwoot.sync.service'
// Or use dynamic import: const { chatwootSyncService } = await import('@/server/integration/chatwoot/services/chatwoot.sync.service')
