 ...
 *
 * `state` is required for CSRF protection (Login-CSRF prevention).
 * It must be between 32 and 128 characters — matching the 64-char hex
 * token generated by `crypto.randomBytes(32).toString('hex')` on the
 * initiation side.
 */
