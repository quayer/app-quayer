...
/**
 * Schema de UserPreferences — atualizar preferências do usuário
 */
const signatureConfigSchema = z.object({
  enabled: z.boolean(),
  format: z.enum(['first_name', 'full_name', 'name_department', 'custom']),
...
export const updatePreferencesSchema = z.object({
  messageSignature: signatureConfigSchema.optional(),
