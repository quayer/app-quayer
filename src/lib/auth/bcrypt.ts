...
/**
 * Gera código OTP seguro usando crypto.randomInt
 *
 * @param digits - Número de dígitos (padrão: 6)
 * @returns Código OTP como string
 */
...
/**
 * Gera recovery codes para 2FA
 *
 * @param count - Número de códigos (padrão: 8)
 * @returns Array de códigos hex
 */
