    ...
    async function loadEnvDefaults() {
      try {
        ...
        if (result.success && result.data) {
          setEnvDefaults(result.data.ai as unknown as EnvDefaults)
        }
      } catch (error) {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Configure as chaves de API dos provedores de IA (OpenAI, Anthropic, OpenRouter).
              </CardDescription>
            </div>
            {hasEnvData && (
              <Button
        ...
        <CardContent className="space-y-6">
            ...
            <Alert className="bg-blue-50 border-blue-200 dark:bg-blue-950/20 dark:border-blue-800" role="note">
              ...
              <AlertDescription className="text-blue-600 dark:text-blue-300">
                <div className="mt-2 space-y-1 text-sm font-mono">
                  <div>API Key: <span className="font-semibold">{envDefaults?.openaiApiKey || 'N/A'}</span></div>
          ...
          <div className="space-y-4">
            <div className="space-y-4">
              <h4 className="font-medium">Chaves de API por Provedor</h4>
              <p className="text-sm text-muted-foreground">
                Configure as chaves de API para cada provedor. O agente usará a chave do provedor selecionado na criação.
              </p>
              ...
              <Tabs defaultValue="openai" className="w-full">
                ...
                <TabsContent value="openai" className="space-y-3 mt-3">
                  ...
                  {formData.openaiApiKey && (
                    <Badge variant="outline" className="text-green-600 border-green-200">Configurada</Badge>
                  )}
                </TabsContent>
                ...
                <TabsContent value="anthropic" className="space-y-3 mt-3">
                  ...
                  <p id="anthropic-key-help" className="text-xs text-muted-foreground">
                    Obtenha em: <a href="https://console.anthropic.com/settings/keys" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">console.anthropic.com</a>
                  </p>
                ...
                <TabsContent value="openrouter" className="space-y-3 mt-3">
                  ...
                  <p id="openrouter-key-help" className="text-xs text-muted-foreground">
                    Obtenha em: <a href="https://openrouter.ai/keys" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">openrouter.ai/keys</a>
                  </p>
