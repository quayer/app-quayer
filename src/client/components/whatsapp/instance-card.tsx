...
import { useDisconnectInstance, useDeleteInstance, useProfilePicture } from '@/client/hooks/useInstance'
...
export function InstanceCard({
  ...
  const { data: profileData } = useProfilePicture((instance.status as string) === 'connected' ? instance.id : '')
      ...
      <Card className="bg-gray-800/50 border-gray-700 hover:border-gray-600 transition-colors">
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start gap-3 flex-1">
              ...
              <Avatar className="h-12 w-12 border-2 border-gray-700">
                <AvatarImage
                  src={(profileData as { profilePictureUrl?: string } | undefined)?.profilePictureUrl || instance.profilePictureUrl || undefined}
                  alt={instance.name}
                />
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <StatusIcon className={`h-3 w-3 mr-1 ${(instance.status as string) === 'connecting' ? 'animate-spin' : ''}`} />
              {statusConfig.label}
            </Badge>
            
            {(instance.status as string) === 'connected' && (
          ...
          <div className="space-y-2 text-sm text-gray-400">
            <div className="flex items-center justify-between">
              <span>Broker:</span>
              <span className="text-gray-300 capitalize">{(instance as any).brokerType}</span>
            </div>
          ...
          <div className="flex gap-2 pt-2">
            ...
            {(instance.status as string) === 'connecting' && (
              <Button 
                disabled
                variant="outline"
