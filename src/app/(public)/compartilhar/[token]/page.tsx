    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <div className="w-48 h-1.5 rounded-full bg-muted overflow-hidden" aria-hidden="true">
            <div
              className={cn(
                "h-full rounded-full transition-all",
                timerState === 'critical' ? "bg-destructive" : timerState === 'warning' ? "bg-amber-500" : "bg-primary"
              )}
