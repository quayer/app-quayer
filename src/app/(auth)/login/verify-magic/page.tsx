...
export default function LoginVerifyMagicPage() {
  ...
  useEffect(() => {
    ...
    const verifyMagicLink = async () => {
      try {
        ...
        const errorMessage = err.message || 'Link inválido ou expirado'
        console.error("Magic link verification error:", errorMessage)
        setStatus('error')
