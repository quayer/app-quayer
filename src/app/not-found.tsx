...
const quickLinks = [
  { href: '/projetos', icon: Bot, label: 'Agentes IA', description: 'Gerencie seus builders de agentes' },
  { href: '/admin', icon: Settings, label: 'Administração', description: 'Painel admin e configurações' },
]
